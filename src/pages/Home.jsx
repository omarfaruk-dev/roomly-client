...
import { FaShieldAlt, FaUserCheck, FaComments, FaLock, FaHandsHelping } from 'react-icons/fa';
...
const SafetyTrust = () => (
  <section className="max-w-7xl mx-auto px-4 py-20">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
      <Slide direction="left" delay={300} duration={1000}>
        <div className="flex flex-col items-center text-center bg-base-100 rounded-xl shadow-md p-6 border-l-4 border-secondary/15 hover:scale-102 hover:border-secondary transition-transform duration-300">
      ...
      <Slide direction="right" delay={300} duration={1000}>
        <div className="flex flex-col items-center text-center bg-base-100 rounded-xl shadow-md p-6 border-l-4 border-primary/15 hover:scale-102 hover:border-primary transition-transform duration-300">
    ...
    <Fade delay={200}>
      <div className="flex justify-center mt-10">
        <div className="flex items-center gap-2 bg-secondary/10 px-6 py-3 rounded-full text-secondary font-medium text-base shadow-sm">
