            ...
            <div className="hidden md:block">
                <Fade duration={3000} delay={300}>
                    <div className="hidden md:flex justify-center items-center">
                        <img src="/logo.png" alt="How Roomly Works" className="w-64 h-64 p-2 object-contain rounded-md shadow-md border-4 border-secondary/15 bg-base-200 transition-all duration-300 hover:grayscale" />
                    </div>
                </Fade>
            </div>
